...
## 1. Quick Start with Ubuntu 20.04 (ROS Noetic)

Nlopt library is added to the project as submodule. Nlopt should be installed from source:  
...
```
  ...
  git clone https://github.com/era-team/Fast-Planner.git
  cd ../
  catkin build
```
